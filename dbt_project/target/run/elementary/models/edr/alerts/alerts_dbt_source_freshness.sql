  ...
  create view "aviasales"."public"."alerts_dbt_source_freshness__dbt_tmp"
...
with results as (
  select * from "aviasales"."public"."dbt_source_freshness_results"
),

sources as (
  select * from "aviasales"."public"."dbt_sources"
)
